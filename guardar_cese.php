...
<big><strong>Resultado de operación:</strong></big><br /><br />
<?php
...
mysqli_query($conexion, "insert into ceses( nombre, apellido, ci, ne, cargo, fecha_cargo, fecha_elaboracion, dia, fm, fa ) values ('$_POST[nombre]', '$_POST[apellido]', '$_POST[ci]', '$_POST[ne]', '$_POST[cargo]', '$_POST[fecha_cargo]', '$_POST[fecha_elaboracion]', '$_POST[dia]','$_POST[fm]','$_POST[fa]')") or die ("Problemas en el select".mysqli_error($conexion));

mysqli_close($conexion);
    
    echo "<b>El Formulario fue enviado con éxito a la base de datos.</b>";

?>

<br /><br /><a href="cese.php">[ Volver a Formulario cese ]</a>
<br /><br /><a href="index.php">[ Volver a Inicio ]</a>
