...
<head>
	...
	<title>Busqueda Credencial</title>
...
<?php include 'partials/menu.php' ?>
	...
	<big><strong>Resultado Consulta Especifica de personal Credenciales: </strong></big><br /><br />
	<form>

		<?php 
			$conexion=mysqli_connect("localhost","root","","test") or die ("Problemas con la conexión");
			$registros=mysqli_query($conexion,"select * from creden where ci='$_POST[datoBuscar]'")or die("Problemas en el select:".mysqli_error($conexion));
			if($reg=mysqli_fetch_array($registros))
			{
				...
				echo "No existe número de Cédula en la tabla credenciales ";
			}
			mysqli_close($conexion);
		?>
	</form><br />
<a href="creden.php">[ Volver a formulario Credencial ]</a><br /><br />
