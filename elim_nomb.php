...
<head>
	...
	<title>Eliminar Nombramiento</title>
...
<?php include 'partials/menu.php' ?>
	...
	<!-- Código en PHP para eliminar de la base de datos el registro de  la tabla cese -->
		...
		//Conexion con la base de datos test, tabla cese
			...
			$registros=mysqli_query($conexion,"select * from nombra where ci='$_POST[codEliminar]'")
			or die("Problemas en el select:".mysqli_error($conexion));

			if($reg=mysqli_fetch_array($registros))
			{
				mysqli_query($conexion, "delete from nombra where ci='$_POST[codEliminar]'") or die("Problemas en el select:".mysqli_error($conexion));
				// mensaje de que se realizo dicha sentencia de elimiinar registro con el numero de cedula
				echo "<b>Se efectuó el borrado del nombramiento.</b><br /><br />";
			}
			mysqli_close($conexion);
		?>
	</form> 
<!--  Fin Código en PHP para eliminar de la base de datos el registro de  la tabla cese -->
<a href="histo_nombra.php">Volver Historial de nombramientos</a>
<a href="nombra.php">Volver a formulario Nombramiento</a><br />
