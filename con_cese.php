...
<!-- se mostrara solo al iniciar sesion -->
			...
			<?php if(!empty($user)): ?><b>Bienvenido. <?= $user['email']; ?>______________________________________________________
...
<hr>
		 <center>
<big><strong>Resultado Consulta Especifica de personal ceses: </strong></big><br /><br />
	<form>

		<?php 
			$conexion=mysqli_connect("localhost","root","","test") or die ("Problemas con la conexión");
			$registros=mysqli_query($conexion,"select * from ceses where ci='$_POST[datoBuscar]'")or die("Problemas en el select:".mysqli_error($conexion));
			if($reg=mysqli_fetch_array($registros))
			{
				...
				echo "Fecha de Elaboración: ".$reg['fecha_elaboracion']."<br /><br />";
			}else{
				echo "No existe número de Cédula en la tabla Ceses. ";
				echo "<br />";
			}
			mysqli_close($conexion);
		?>
	</form><br />
	<a href="cese.php">[ Formulario Ceses ]</a><br /><br />
	<a href="histo_cese.php">[ Historial de Ceses ]</a><br /><br />
