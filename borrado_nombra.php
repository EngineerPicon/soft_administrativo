...
<head>
	...
	<title>Borrado General Nombramientos</title>
...
<?php include 'partials/menu.php' ?>
	 ...
	 <?php 
	 	...
	 	mysqli_query($conexion,"delete from nombra") or die ("Problemas en el select:".mysqli_error($conexion));
	 	echo "Se efectuo el borrado de todos los Nombramientos.";
	 	mysqli_close($conexion);
	 ?>

<!-- Vinculo para regresar a menu de credencial -->
<a href="nombra.php">[ Volver a formulario Nombramiento ]</a>
